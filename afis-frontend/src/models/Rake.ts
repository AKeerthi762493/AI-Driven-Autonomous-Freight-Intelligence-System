...
export interface IRake extends Document {
  rakeNumber: string; wagons: mongoose.Types.ObjectId[]; route?: mongoose.Types.ObjectId;
  status: RakeStatus; currentLocation: string; driver?: string; totalCapacity: number;
  departureTime?: Date; arrivalTime?: Date; createdAt: Date; updatedAt: Date;
}
